...
/usr/bin/php /var/www/html/moodle/admin/cli/install.php --wwwroot='http://192.168.56.20' --dataroot='/var/www/html/moodledata' --dbtype='mariadb' --dbhost='192.168.56.30' --dbuser='moodle_devops' --dbpass=$DB_USER_PWD --dbport='3306'  --shortname='moodle.local' --adminuser='admin' --adminpass='bubuntu' --adminemail='admin@yo.lo' --fullname='moodle.local_sii2019devops' --non-interactive --agree-license
